...
function replaceColors(filePath) {
  ...
  content = content.replace(/py-2 px-4 text-center text-\[11px\] font-bold tracking-widest/g, 'py-2 px-4 text-center text-[10px] font-medium tracking-[0.2em]');

  // 3. Hero section text - cinematic
  content = content.replace(/text-4xl sm:text-5xl xl:text-6xl font-cinzel font-black tracking-tight leading-none/g, 'text-4xl sm:text-5xl xl:text-6xl font-cinzel font-light tracking-widest leading-tight');
